...
from featuresextraction import features_extraction
...
cell01, FEC01, Qloss01, RPT01, FEC_final01, RUL01 = features_extraction('1C25degC/mat/data.mat', '1C25degC/mat/EOCV.mat', '1C25degC/mat/EFC.mat', '1C25degC/mat/RPT_EFC.mat', '1C25degC/mat/SOH.mat', V_min=3.65, V_max=4.1, I_min=100, I_max=500) 
cell02, FEC02, Qloss02, RPT02, FEC_final02, RUL02 = features_extraction('1.3C25degC/mat/data.mat', '1.3C25degC/mat/EOCV.mat', '1.3C25degC/mat/EFC.mat', '1.3C25degC/mat/RPT_EFC.mat', '1.3C25degC/mat/SOH.mat', V_min=3.65, V_max=4.1, I_min=100, I_max=500) 
cell03, FEC03, Qloss03, RPT03, FEC_final03, RUL03 = features_extraction('2C25degCs2/mat/data.mat', '2C25degCs2/mat/EOCV.mat', '2C25degCs2/mat/EFC.mat', '2C25degCs2/mat/RPT_EFC.mat', '2C25degCs2/mat/SOH.mat', V_min=3.65, V_max=4.1, I_min=100, I_max=500) 
cell04, FEC04, Qloss04, RPT04, FEC_final04, RUL04 = features_extraction('MC25degCS1/mat/data.mat', 'MC25degCS1/mat/EOCV.mat', 'MC25degCS1/mat/EFC.mat', 'MC25degCS1/mat/RPT_EFC.mat', 'MC25degCS1/mat/SOH.mat', V_min=3.65, V_max=4.1, I_min=100, I_max=500) 
cell05, FEC05, Qloss05, RPT05, FEC_final05, RUL05 = features_extraction('2C35degC/mat/data.mat', '2C35degC/mat/EOCV.mat', '2C35degC/mat/EFC.mat', '2C35degC/mat/RPT_EFC.mat', '2C35degC/mat/SOH.mat', V_min=3.65, V_max=4.1, I_min=100, I_max=500) 
cell06, FEC06, Qloss06, RPT06, FEC_final06, RUL06 = features_extraction('1.3C15degCs1/mat/data.mat', '1.3C15degCs1/mat/EOCV.mat', '1.3C15degCs1/mat/EFC.mat', '1.3C15degCs1/mat/RPT_EFC.mat', '1.3C15degCs1/mat/SOH.mat', V_min=3.65, V_max=4.1, I_min=100, I_max=500) 
cell07, FEC07, Qloss07, RPT07, FEC_final07, RUL07 = features_extraction('1.3C15degCs2/mat/data.mat', '1.3C15degCs2/mat/EOCV.mat', '1.3C15degCs2/mat/EFC.mat', '1.3C15degCs2/mat/RPT_EFC.mat', '1.3C15degCs2/mat/SOH.mat', V_min=3.65, V_max=4.1, I_min=100, I_max=500) 
cell08, FEC08, Qloss08, RPT08, FEC_final08, RUL08 = features_extraction('2C0degCs1/mat/data.mat', '2C0degCs1/mat/EOCV.mat', '2C0degCs1/mat/EFC.mat', '2C0degCs1/mat/RPT_EFC.mat', '2C0degCs1/mat/SOH.mat', V_min=3.65, V_max=4.1, I_min=100, I_max=500) 
cell09, FEC09, Qloss09, RPT09, FEC_final09, RUL09 = features_extraction('2C0degCs2/mat/data.mat', '2C0degCs2/mat/EOCV.mat', '2C0degCs2/mat/EFC.mat', '2C0degCs2/mat/RPT_EFC.mat', '2C0degCs2/mat/SOH.mat', V_min=3.65, V_max=4.1, I_min=100, I_max=500)
cell10, FEC10, Qloss10, RPT10, FEC_final10, RUL10 = features_extraction('MC25degCs2/mat/data.mat', 'MC25degCs2/mat/EOCV.mat', 'MC25degCs2/mat/EFC.mat', 'MC25degCs2/mat/RPT_EFC.mat', 'MC25degCs2/mat/SOH.mat', V_min=3.65, V_max=4.1, I_min=100, I_max=500)
...
physical_feature_conditions = [
    ...
    {"label": "Without Physical Features", "features": ["EFC"]}  # 只剩下 EFC
]
...
for train_ratio in train_ratios:
    for condition in physical_feature_conditions:
        ...
        for seed in random_seeds:
            ...
            train_selected_data, test_selected_data, global_selected_features, global_scaler = process_train_val_test_data_optimized(
            ...
            # train RF model
            rf_model_mmd, rf_results_mmd, y_train_pred, y_test_pred, y_train, y_test = train_and_evaluate_rf_mmd(
...
for condition in physical_feature_conditions:
    ...
    for run_id, seed in enumerate(random_seeds):
        ...
        for cycle in test_row_indices:
            ...
            X_train = X_train_full[:cycle]
            y_train = y_train_full[:cycle]
            ...
            # train RF model
            rf_model, _, _, y_test_pred, _, _ = train_and_evaluate_rf(
...
# plot heatmap for SHAP mean value
